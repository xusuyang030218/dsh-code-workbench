/**
 * host 半验证：加载 index.js 的 apply()，用真实 dsh-tools 校验 schema，
...
import { apply as applyIndex } from '../lib/host/index.js'
import { saveFile, _clearForTest } from '../lib/host/store.js'
...
let threw = false
try { await tool.execute({ action: 'read', fileId: 'nope' }) } catch { threw = true }
